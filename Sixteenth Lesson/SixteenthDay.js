...
//The use of 'this'
//Exercise # 1
function Earbuds(brand) {
    this.brand = brand;
}

Earbuds.prototype.music = function() {
...
//Exercise # 2
function EcoDot(brand) {
    this.brand = brand;
}

EcoDot.prototype.question = function() {
...
const JLAB_TWO = new Earbuds("Jlab");
JLAB_TWO.music();
...
const ALEXA_TWO = new EcoDot("Alexa EcoDot");
ALEXA_TWO.question();
...
for (let properties in USER_GRADES) {
...
for (let properties of PROPERTIES) {
    console.log(properties);
}
