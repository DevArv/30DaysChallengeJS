...
Deberás implementar la lógica de las siguientes clases con las siguientes propiedades y métodos:
...
class User {
    ...
    notify(task) {
        console.log(`${this.name} ha completado la tarea ${task.description}`);
    }
}
